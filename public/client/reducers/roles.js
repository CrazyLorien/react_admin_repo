...
export default function roles(state = { rolesList: [], editedRole: { Permissions: [] }, showReload: true }, action) {
    switch (action.type) {
        ...
        case 'GET_ROLE_BY_ID_SUCCESS':
            {
                ...
                return {...state, rolesList: roles, editedRole: role, showReload: false };
            }
